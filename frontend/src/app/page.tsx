    ...
    <main className="flex flex-col items-center justify-center min-h-screen bg-[#e0e5ec] ">
      <div className="neumorphic p-10 flex flex-col items-center max-w-lg w-full">
        ...
        <div className="flex gap-6">
          <Link
            href="/signup"
            className="px-6 py-3 rounded-full neumorphic text-purple-600  font-semibold shadow hover:scale-105 transition-transform"
          >
            Get Started
          </Link>
          <Link
            href="/login"
            className="px-6 py-3 rounded-full neumorphic text-blue-600  font-semibold shadow hover:scale-105 transition-transform"
          >
            Login
          </Link>
        </div>
        <div className="mt-10 flex flex-col items-center">
          <span className="text-sm text-gray-400 mb-2">Fast • Secure • Fun</span>
